...
from strategies.AllWeatherStrategy import AllWeatherStrategy
...
if __name__ == "__main__":
    ...
    run_backtest(strategy=MomentumStrategy, symbols='AAPL', start='2023-01-01', end='2024-10-31', timeframe=TimeFrame.Day, cash=100000)
